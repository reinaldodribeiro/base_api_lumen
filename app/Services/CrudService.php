...
/**
 * Classe de Négocio referente ao
 *
 * @package App\Business;
 * @author Reinaldo D. Ribeiro
 */
abstract class CrudService
{
    ...
    protected function performUpdate($model, $data) {
        return DB::transaction(function () use ($model, $data) {
            ...
            return $this->postUpdate($model, $this->prepareUpdate($model, $data));
        });
    }
    ...
    protected function performSave($data) {
        return DB::transaction(function () use ($data) {
            ...
            $model->save();
            return $this->postSave($model, $this->prepareSave($data));
        });
    }
